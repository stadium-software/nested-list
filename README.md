...
## CSS
The CSS below is required for the correct functioning of the module. Variables exposed in the [*nested-list-variables.css*](nested-list-variables.css) file can be [customised](#customising-css).
...
### v6.12+
1. Create a folder called "CSS" inside of your Embedded Files in your application
2. Drag the CSS files from this repo [*nested-list.css*](nested-list.css) into that folder
...
4. Add the [*nested-list-variables.css*](nested-list-variables.css) to the "CSS" folder in the EmbeddedFiles (overwrite)
...
**NOTE: Do not change any of the CSS in the 'nested-list.css' file**
